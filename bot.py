import logging
from telegram import Bot, Update, ReplyKeyboardMarkup, ReplyKeyboardRemove, InlineKeyboardMarkup, InlineKeyboardButton, KeyboardButton
from telegram.ext import ApplicationBuilder, ContextTypes, CommandHandler, MessageHandler, filters, CallbackQueryHandler, ConversationHandler, CallbackContext, Updater
import tracemalloc
tracemalloc.start()
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == 1194700554:
        #admin panel
        keyboard = ReplyKeyboardMarkup(
            [['Изменить курс рубля', 'Изменить курс USDT'], ["Изменить процент маржи", 'Узнать курс']],
